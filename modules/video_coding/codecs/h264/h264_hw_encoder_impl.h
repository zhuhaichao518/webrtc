...
#ifndef MODULES_VIDEO_CODING_CODECS_H264_H264_HW_ENCODER_IMPL_H_
#define MODULES_VIDEO_CODING_CODECS_H264_H264_HW_ENCODER_IMPL_H_
...
class H264HWEncoderImpl : public H264HWEncoder {
 public:
  struct LayerConfig {
    int simulcast_idx = 0;
    int width = -1;
 ...
 public:
  ...
  explicit H264HWEncoderImpl(const cricket::VideoCodec& codec);
  ~H264HWEncoderImpl() override;
